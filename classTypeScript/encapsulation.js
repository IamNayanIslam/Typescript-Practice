...
var User = /** @class */ (function () {
    ...
    User.prototype.display = function () {
        log("User Name: ".concat(this.userName, ", Age: ").concat(this.age));
    };
    return User;
}());
var Student = /** @class */ (function (_super) {
    ...
    Student.prototype.display = function () {
        log("User Name: ".concat(this.userName, ", Age: ").concat(this.age, " and Id: ").concat(this.studentId));
    };
...
var student1 = new Student("Nayan Islam", 28, 101);
